...
\end{tikzpicture}\vspace{2pt}\small\textcolor{cnSlate}{Time'Eats \textbf{·} Budget Prévisionnel — \textit{[Nom projet]}}}
...
\rowcolor{cnIce}
Intégration ESN        & CAPEX/OPEX & \textit{[X]} & \textit{[X\%]} & Forfait \\
